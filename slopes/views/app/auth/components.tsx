...
export const ButtonComponent = (props: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
  return (
    <button
      {...props}
...
export const LinkComponent = (props: React.AnchorHTMLAttributes<HTMLAnchorElement>) => {
  return <a {...props} className="font-medium text-blue-500 hover:text-blue-600" />;
};
